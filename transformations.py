...
# bert_masking("This is a nice movie and good result")
...
#     embeddings1 = model_sim.encode([s1], convert_to_tensor=True)
#     embeddings2 = model_sim.encode([s2], convert_to_tensor=True)
